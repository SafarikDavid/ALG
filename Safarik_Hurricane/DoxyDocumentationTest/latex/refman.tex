...
\vspace*{7cm}
\begin{center}%
{\Large Hurricanes\+\_\+\+Documentations \\[1ex]\large Final }\\
\vspace*{1cm}
...
\input{namespacesafarik__hurricane}
\chapter{Dokumentace tříd}
\input{classsafarik__hurricane_1_1_comparator_by_speed}
\input{classsafarik__hurricane_1_1_hurricane}
\input{classsafarik__hurricane_1_1_hurricanes_data}
\input{classsafarik__hurricane_1_1_main___hurricane}
\chapter{Dokumentace souborů}
\input{hurricanedata_8txt}
\input{_comparator_by_speed_8java}
\input{_hurricane_8java}
\input{_hurricanes_data_8java}
\input{_main___hurricane_8java}
